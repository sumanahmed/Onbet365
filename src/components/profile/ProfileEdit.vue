                ...
                <div class="profile-wrapper">
                    <form action="" method="POST">
                        <input type="hidden" name="_token" value="">                                            <div class="form-group">
                            ...
                            <input id="namename" class="form-control" type="text" name="namename" placeholder="Name" value="dream7" readonly="">
                            ...
                            <input required="" id="phone" class="form-control" type="text" name="phone" value="01812141414">
                        </div>
